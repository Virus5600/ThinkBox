	...
	<div class="row">
		...
		<div class="col-12 col-md-10">
			<div class="row justify-content-center my-3 mx-1">
				{{-- INNOVATIONS --}}
				<div class="col-12 col-lg-5 col-xl-3 invisiborder rounded dark-shadow px-0 pb-3 mx-4 my-3">
					<div class="card-body">
							...
							<div class="row">
								<div class="col-12 align-items-center">
									<div class="row">
										...
										<div class="col-12 col-md-9 ml-0 pl-1 text-center text-lg-left">
								...
								<div class="col-12">
									<h4 class="text-truncate my-3 tooltip-html" data-toggle="tooltip" data-placement="bottom" title="Development of an Information-Based Dashboard: Automation of Barangay Information Profiling System (BIPS) for Decision Support towards e-Governance">
					...
					<div class="card-body">
						<div class="card-title">
							<div class="row">
								...
								<div class="col-12">
									<h4 class="text-truncate my-3 tooltip-html" data-toggle="tooltip" data-placement="bottom" title="Exploring Hybrid Linguistic Feature Sets to Measure Filipino Text Readability">
					...
					<div class="card-body">
						<div class="card-title">
							<div class="row">
								...
								<div class="col-12">
									<h4 class="text-truncate my-3 tooltip-html" data-toggle="tooltip" data-placement="bottom" title="A Speaker Accent Recognition System for Filipino Language">
