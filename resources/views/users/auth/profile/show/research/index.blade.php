						...
						<div class="modal-dialog modal-dialog-centered" role="document">
							<div class="modal-content">
								<div class="modal-header">
									<h5 class="modal-title" id="addItemTitle">Add Research</h5>
						...
						<tr>
							...
							<div class="modal fade" id="editItem1" data-backdrop="static" role="dialog" aria-hidden="true" aria-labelledby="editItemTitle1">
								<div class="modal-dialog modal-dialog-centered" role="document">
									<div class="modal-content">
										<div class="modal-header">
											<h5 class="modal-title" id="editItemTitle1">Edit Research 1</h5>
											<button type="button" class="close" data-dismiss="modal" aria-label="Close">
												<span aria-hidden="true">&times;</span>
											</button>
										</div>
										...
										<div class="modal-body">
											<form>
												<div class="form-group">
													<label class="form-label" for="research_title">Research Title</label>
													<input type="text" class="form-control" name="research_title1" value="Research 1"/>
												</div>
