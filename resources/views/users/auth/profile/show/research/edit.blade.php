				...
				<div class="row">
					...
					<div class="form-group col-12 d-flex flex-d-row">
						<div class="form-check mx-3">
							<input class="form-check-input" type="checkbox" name="is_viewable" id="is_viewable" {{$research->is_viewable ? 'checked' : ''}}/>
							<label class="form-check-label font-weight-bold" for="is_viewable">Viewable</label>
						</div>

						<div class="form-check mx-3">
							<input class="form-check-input" type="checkbox" name="is_downloadable" id="is_downloadable" {{$research->is_downloadable ? 'checked' : ''}}/>
