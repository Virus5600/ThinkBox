...
<div class="container-fluid my-5 px-5">
	...
	<div class="row my-5">
		...
		<div class="col-12 col-md-6">
			...
			<span class="text-center font-weight-bold border-custom border border-thick border-left-0 border-top-0 border-right-0 px-1"><a class="text-custom-2 text-decoration-none" href="{{ route('faculty.research', [$id]) }}">View all research paper</a></span>
		</div>
		...
		<div class="col-12 col-md-6">
			...
			<span class="text-center font-weight-bold border-custom border border-thick border-left-0 border-top-0 border-right-0 px-1"><a class="text-custom-2 text-decoration-none" href="{{ route('faculty.innovations', [$id]) }}">View all innovations</a></span>
		</div>
	</div>
	...
	<div class="row my-5">
		<div class="col-12">
			...
			<span class="text-center font-weight-bold border-custom border border-thick border-left-0 border-top-0 border-right-0 px-1"><a class="text-custom-2 text-decoration-none" href="{{ route('faculty.materials', [$id]) }}">View all course materials</a></span>
		</div>
	</div>
</div>
@endsection