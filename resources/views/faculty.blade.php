		...
		<div class="col col-md-10">
			...
			<div class="row mb-4">
				...
				<div class="col col-md-6">
					<div class="container-fluid dark-shadow invisiborder rounded overflow-hidden h-100 w-100">
						<div class="row">
							<div class="col-12 col-md-4" style="background: #fff url('/images/TEMPORARY/home/user1.jpg') no-repeat center; background-size: cover; min-height: calc(100%/3);">
							</div>
							...
							<div class="col-12 col-md-8">
								...
								<p class="m-3">
									<a class="float-right text-decoration-none read-more mb-3" href=''>View Profile <i class="fas fa-chevron-right"></i></a>
								</p>
							</div>
						</div>
					</div>
				...
				<div class="col col-md-6">
					<div class="container-fluid dark-shadow invisiborder rounded overflow-hidden h-100 w-100">
						<div class="row">
							<div class="col-12 col-md-4" style="background: #fff url('/images/TEMPORARY/home/user4.jpg') no-repeat center; background-size: cover;">
							</div>
			...
			<div class="row my-4">
				...
				<div class="col col-md-6">
					<div class="container-fluid dark-shadow invisiborder rounded overflow-hidden h-100 w-100">
						<div class="row">
							<div class="col-12 col-md-4" style="background: #fff url('/images/TEMPORARY/home/user2.jpg') no-repeat center; background-size: cover; min-height: calc(100%/3);">
							</div>
				...
				<div class="col col-md-6">
					<div class="container-fluid dark-shadow invisiborder rounded overflow-hidden h-100 w-100">
						<div class="row">
							<div class="col-12 col-md-4" style="background: #fff url('/images/TEMPORARY/home/user3.jpg') no-repeat center; background-size: cover;">
							</div>
