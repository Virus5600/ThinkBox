...
<html lang="en">
	<head>
		...
		{{-- Title --}}
		<title>{{ env('APP_NAME') }} | Service Unavailable</title>
	</head>
		...
		<div class="container-fluid d-flex flex-d-col" style="height: -webkit-fill-available;">
            <div class="row mt-auto">
                <div class="col-12 col-lg-6 offset-lg-3">
                    <h1 class="text-center" style="font-size: 25vh;">500</h1>
                </div>
            </div>

			<div class="row mb-auto">
				<div class="col-12 col-lg-8 offset-lg-2 text-center">
                    <h2 style="font-size: 12.5vh">Something must have gone haywire!</h2>
